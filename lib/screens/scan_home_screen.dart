...
class _CustomFloatingButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton(
      ...
      onPressed: () async {
        ...
        //     '#fff', 'Cancelar', true, ScanMode.QR);
        // String scanData = '10.341044114051419, -67.041591756076';
        String scanData = 'https://flutter.dev';
  ...
  void handleNewScan(String scanData, BuildContext context) async {
    ScansProvider scanDB = Provider.of<ScansProvider>(context, listen: false);

    Scan newScan = Scan(value: scanData);
    await scanDB.create(newScan);
